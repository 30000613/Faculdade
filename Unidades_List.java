 ...
 * @author Utilizador
 */
public class Unidades_List extends javax.swing.JFrame {

    /**
     * Creates new form EquipmentList
     */
    public Unidades_List() {
        initComponents();
        PopulateTable();
  ...
  /*  
    ...
    String columns[] = {"Nome","Codigo","Descricao"};
    return columns;
};*/
    ...
    String query_Select = "Select * from UNIDADES";
    ...
    DefaultTableModel model = (DefaultTableModel) EquipmentTable.getModel();
     ...
     columns[2] = rsmd.getColumnName(4);
     columns[3] = "ID";
    ...
    while(rs.next()){
     String data[] = {rs.getString(2),rs.getString(3),rs.getString(4), rs.getString(1)};
    ...
    private void EquipmentTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EquipmentTableMouseClicked
        ...
        Unidades_DetailPage DetailPage = new Unidades_DetailPage(Integer.parseInt(value));
    ...
    private void CreatebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CreatebuttonActionPerformed
        Unidade_InsertPage createscreen = new Unidade_InsertPage();
        createscreen.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Unidades_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Unidades_List().setVisible(true);
            }
