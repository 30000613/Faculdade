 ...
 * @author Utilizador
 */
public class SUnidades_List extends javax.swing.JFrame {

    /**
     * Creates new form EquipmentList
     */
    public SUnidades_List() {
        initComponents();
        PopulateTable();
        
    }
    public static String[] GetColumns(){
   String columns[] = {"Nome","Descricao","Tipo Equipamento"};
    return columns;
};
    ...
    String query_Select = "Select * from SUBUNIDADES";
    ...
    private void EquipmentTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EquipmentTableMouseClicked
        ...
        SUnidade_DetailPage detailscreen = new SUnidade_DetailPage(EquipmentTable.getSelectedRow()+1);
        detailscreen.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SUnidades_List.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SUnidades_List().setVisible(true);
            }
